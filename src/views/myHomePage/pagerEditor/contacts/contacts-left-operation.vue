<template>
  <div class="left-contact">
    <div id="contact-banner" class="top">
...
<script>
  ...
  export default{
    ...
    mounted () {
      this.getTempCode()
      this.getBannerImg({position: 'CONTACTS'})
    ...
    methods: {
      ...
      save () {
        ...
        myWebSiteApi.contactBanner({detailStr: JSON.stringify(this.detailStr)}).then(res => {
          if (!res.data.code) {
